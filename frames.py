# FRAMES: Tente criar um teclado numérico de uma calculadora, ou seja, com 12 botões.
...
botao_13 = tk.Button(quadro_4, command = Funcao_13, text=':')
botao_13.pack(side = 'top', fill='both', expand =1)
botao_14 = tk.Button(quadro_4, command = Funcao_14, text='x')
botao_14.pack(side = 'top', fill='both', expand =1)
botao_15 = tk.Button(quadro_4, command = Funcao_15, text='-')
botao_15.pack(side = 'top', fill='both', expand =1)
botao_16 = tk.Button(quadro_4, command = Funcao_16, text='+')
